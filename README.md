...
Quatro projetos progressivos de controle de servo motor com ESP32, do movimento básico até sistemas automáticos de irrigação e rastreamento de luz. Desenvolvidos como parte dos estudos de eletrônica embarcada e IoT.
...
- Sensor LDR (fotoresistor) (projeto 4)
...
---
## 4️⃣ servo-ldr
Sensor de luminosidade (LDR) controla a varredura do servo, simulando um rastreador que reage à quantidade de luz incidente.
**Conexões:**
| Componente | ESP32 |
|---|---|
| Servo (sinal) | GPIO 5 |
| LDR (saída analógica) | GPIO 35 |
**Como funciona:**
- Lê continuamente o valor analógico do LDR
- **Leitura > 2250** (pouca luz incidindo no sensor) → servo varre de 0° a 180°
- **Leitura ≤ 2250** (luz suficiente) → servo permanece parado em 0°
- A varredura é interrompida a qualquer momento que a leitura volte a indicar luz suficiente
---
## 📈 Evolução do projeto
...
3. **Controle automático por sensor (umidade)** → lógica condicional aplicada a um cenário real (IoT/automação)
4. **Controle automático por sensor (luminosidade)** → nova entrada analógica aplicada à mesma lógica de varredura condicional
---
## 👤 Autor
**Luiz Paulo Soares**
